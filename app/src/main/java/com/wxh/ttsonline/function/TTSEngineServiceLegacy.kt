 ...
 */
class TTSEngineServiceLegacy : TextToSpeechService() {
    ...
    override fun onCreate() {
        ...
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceLegacy onCreate")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceLegacy onDestroy")
    }
    ...
    override fun onSynthesizeText(request: SynthesisRequest, callback: SynthesisCallback) {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceLegacy onSynthesizeText: ${request.charSequenceText}")
     ...
     */
    override fun onStop() {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceLegacy onStop")
        try {
