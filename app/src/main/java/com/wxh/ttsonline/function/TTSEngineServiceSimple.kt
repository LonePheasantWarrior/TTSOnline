 ...
 * 尝试使用最基本的TTS引擎注册方式
 */
class TTSEngineServiceSimple : TextToSpeechService() {
    ...
    override fun onCreate() {
        ...
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceSimple onCreate")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceSimple onDestroy")
    }
    ...
    override fun onSynthesizeText(request: SynthesisRequest, callback: SynthesisCallback) {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceSimple onSynthesizeText: ${request.charSequenceText}")
     ...
     */
    override fun onStop() {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceSimple onStop")
        try {
