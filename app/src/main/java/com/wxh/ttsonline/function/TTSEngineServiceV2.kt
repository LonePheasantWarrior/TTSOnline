...
/**
 * TTS引擎服务类 V2 - 使用Android 12+的新接口
 * 用于注册到系统的"文字转语音输出"菜单中
 */
class TTSEngineServiceV2 : TextToSpeechService() {
    ...
    override fun onCreate() {
        ...
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceV2 onCreate")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceV2 onDestroy")
    }
    ...
    override fun onSynthesizeText(request: SynthesisRequest, callback: SynthesisCallback) {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceV2 onSynthesizeText: ${request.charSequenceText}")
     ...
     */
    override fun onStop() {
        Log.d(LogTag.SDK_INFO, "TTSEngineServiceV2 onStop")
        try {
